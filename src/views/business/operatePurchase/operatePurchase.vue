  ...
  <d2-container>
    <template slot="header">
      <div style="float:left;padding-top:3px">
        <el-radio-group @input="pageList()" v-model="filterFormData.statusCode" size="medium">
          ...
          <el-radio-button label="已交货" @click="pageList()">已交货</el-radio-button>
      ...
      <div  style="float:right;" v-if="filterFormData.statusCode === '待下单'" >
        ...
        <el-button size="medium" @click="handleBatchOrder">下单</el-button>
      ...
      <div  style="float:right;" v-if="filterFormData.statusCode === '已交货'" >
      ...
      <div style="float:right;" v-if="filterFormData.statusCode === '已下单'">
        ...
        <el-button size="medium"  @click="handleBatchOrder">修改</el-button>
        <el-button size="medium"  @click="handleRemove">删除</el-button>
        <el-button size="medium"  @click="pageList()">刷新</el-button>
      </div>
    </template>
    ...
    <template>
      ...
      <vxe-table
        ...
        <vxe-column field="statusCode" title="状态标识" width="100" :visible="filterFormData.statusCode==='全部'"></vxe-column>
        ...
        <vxe-column field="shipAmount" title="其他费用" width="100" :formatter="formatterAmount"></vxe-column>
        <vxe-column field="sumAmount" title="采购总额" width="120" :formatter="formatterAmount"></vxe-column>
        <vxe-column field="purVolume" title="采购体积" width="100" :formatter="formatterVolume"></vxe-column>
        ...
        <vxe-column field="totalBox" title="总箱数" width="80" :formatter="formatterOnePoint"></vxe-column>
        <vxe-column field="purTime" title="采购时间" width="120"></vxe-column>
        <vxe-column field="shipType" title="运输方式" width="120"></vxe-column>
        <vxe-column field="boxLength" title="单箱长/CM" width="120" :formatter="formatterTwoPoint"></vxe-column>
        <vxe-column field="boxWidth" title="单箱宽/CM" width="120" :formatter="formatterTwoPoint"></vxe-column>
        <vxe-column field="boxHigh" title="单箱高/CM" width="120" :formatter="formatterTwoPoint"></vxe-column>
      ...
      <vxe-modal v-if="showPurchaseComplete" title="订单交货" v-model="showPurchaseComplete"
      :visible.sync="showPurchaseComplete" show-footer width="40%" height="300px">
        <template #footer>
          <vxe-button status="primary" @click="completeSubmit">确定</vxe-button>
          <vxe-button @click="showPurchaseComplete=false">取消</vxe-button>
        </template>
        采购单号：<el-tag :key="purNo" v-for="purNo in purCompleteData.purNos" :disable-transitions="false">{{purNo}}</el-tag><br><br>
      ...
      <ShopGoodsOrderComponentVue
        ...
        :defaultPurGoodsName="defaultPurGoodsName"
...
import ShopGoodsOrderComponentVue from '@/views/business/operatePurchase/components/shopGoodsOrderComponent.vue'
